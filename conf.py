...
BLOG_AUTHOR = "Mart\u00edn Gait\u00e1n"  # (translatable)
BLOG_TITLE = "tin_nqn"  # (translatable)
...
BLOG_DESCRIPTION = ">>> me.geek.post()"  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    "en": (
        ("/en/about.html", "About me"),
	    ("/en/talks.html", "Talks"),
		('/en/archive.html', 'Archivos'),
...
DEPLOY_COMMANDS = {'default': ['git subtree push --prefix=output origin master']}
...
TWITTER_CARD = {
    ...
    'creator': '@tin_nqn_',  # Username for the content creator / author.
    'creator:id': 40654511,  # Same as creator, but the Twitter user's ID.
}
